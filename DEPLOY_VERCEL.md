...
| :--- | :--- | :--- |
| `GEMINI_API_KEY` | *(Khóa Gemini API của bạn từ Google AI Studio)* | Production, Preview |
| `FIREBASE_SERVICE_ACCOUNT_BASE64` | *(Chuỗi Base64 của file JSON Service Account Firebase)* | Production, Preview |
| `VITE_FIREBASE_API_KEY` | `AIzaSyCMnga6xRIxgl3fGB0_50OYczmy7ER6kLA` | Production, Preview |
| `VITE_FIREBASE_AUTH_DOMAIN` | `wey-playground.firebaseapp.com` | Production, Preview |
| `VITE_FIREBASE_PROJECT_ID` | `wey-playground` | Production, Preview |
| `VITE_FIREBASE_STORAGE_BUCKET` | `wey-playground.firebasestorage.app` | Production, Preview |
| `VITE_FIREBASE_MESSAGING_SENDER_ID` | `333755003429` | Production, Preview |
| `VITE_FIREBASE_APP_ID` | `1:333755003429:web:70ffc80698a14ed50dc5cc` | Production, Preview |
| `VITE_CLOUDINARY_CLOUD_NAME` | `r7hnjozd` | Production, Preview |
| `VITE_CLOUDINARY_UPLOAD_PRESET` | `wey_playground_upload` | Production, Preview |
