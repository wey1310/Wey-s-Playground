...
export const WerewolfDossierModal: React.FC<WerewolfDossierModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/80 backdrop-blur-md select-none overflow-y-auto animate-fade-in">
      <motion.div
        initial={{ scale: 0.95, opacity: 0, y: 20 }}
        animate={{ scale: 1, opacity: 1, y: 0 }}
        className="w-full max-w-4xl bg-[#FFFDF5] border-2 border-[#DED5B8] rounded-3xl shadow-[0_25px_60px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col max-h-[94vh]"
      >
        {/* Header Banner */}
        <div className="p-5 sm:p-6 bg-gradient-to-r from-[#35452E] via-[#4F683C] to-[#35452E] text-white text-center relative overflow-hidden shrink-0">
          <div className="relative z-10">
            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-black bg-[#E9F0D9] text-[#35452E] uppercase tracking-widest mb-2 shadow-xs">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Tổng Kết Cuộc Điều Tra Ngôi Làng ({totalNights} Đêm)</span>
            </span>
            <h2 className="text-2xl sm:text-3xl font-black text-white">
              🏆 BẢNG VÀNG ĐIỀU TRA VIÊN XUẤT SẮC
            </h2>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <div>
            <h3 className="text-xs font-black uppercase tracking-wider text-[#35452E] mb-3 flex items-center gap-2">
              <Trophy className="w-4 h-4 text-amber-500" />
              <span>Thứ Hạng & Điểm Số Các Đội</span>
            </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pt-2 border-t border-[#DED5B8] flex items-center justify-between">
                      ...
                      <div className="text-lg font-black text-[#4F683C]">
                        {team.score} đ
                      </div>
                    </div>
                  </div>
          ...
          <div>
            <h3 className="text-xs font-black uppercase tracking-wider text-[#35452E] mb-3 flex items-center gap-2">
              <Award className="w-4 h-4 text-[#4F683C]" />
              ...
              {npcs.map(npc => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-2 pt-2 border-t border-[#E5DEC7] space-y-1">
        ...
        {/* Footer Actions */}
        <div className="p-4 bg-[#F8F3E5] border-t border-[#DED5B8] flex items-center justify-between">
          <button
            onClick={onBackToHome}
            className="flex items-center gap-2 px-5 py-2.5 rounded-2xl bg-white hover:bg-slate-100 text-slate-700 font-bold text-xs border border-[#DED5B8] transition cursor-pointer"
          >
