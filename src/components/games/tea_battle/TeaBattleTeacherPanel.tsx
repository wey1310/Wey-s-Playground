              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl bg-amber-600/20 hover:bg-amber-600/40 border border-amber-500/50 text-amber-600 font-bold text-xs flex items-center justify-center gap-1.5 transition-colors"
                  >
