    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/70 backdrop-blur-sm backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-gradient-to-b from-[#2e1c4e] via-[#1a0f30] to-[#0d0718] border-4 border-purple-500/80 rounded-3xl p-6 sm:p-8 shadow-2xl text-w-text-main select-none"
        >
          <button
            type="button"
            onClick={onClose}
            className="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/10 hover:bg-rose-600 flex items-center justify-center text-w-text-main transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-amber-600 uppercase tracking-wide">
          ...
          <div className="space-y-3.5 text-sm sm:text-base">
            <div className="flex items-start gap-3 bg-purple-950/60 border border-purple-500/40 rounded-2xl p-3.5">
              <span className="w-7 h-7 rounded-xl bg-purple-500 text-w-text-main font-black text-sm flex items-center justify-center shrink-0">
                1
              </span>
              <p className="text-zinc-200">
                <strong className="text-amber-600">Bàn Trà Tatami:</strong> Ban đầu xuất hiện các cốc trà bằng tre được gắn số thứ tự tương ứng với số câu hỏi trong ngân hàng câu hỏi.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 bg-purple-950/60 border border-purple-500/40 rounded-2xl p-3.5">
              ...
              <p className="text-zinc-200">
                <strong className="text-amber-600">Chọn Cốc Trà:</strong> Mỗi đội đến lượt sẽ thảo luận và chọn 1 cốc trà trên bàn thi đấu để mở câu hỏi.
              </p>
            </div>
