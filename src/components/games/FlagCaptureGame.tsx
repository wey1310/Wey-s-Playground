  ...
  return (
    <div className="w-full h-[100dvh] bg-w-bg-alt text-slate-100 flex flex-col font-sans select-none overflow-hidden">
      ...
      <div className="flex-1 grid grid-cols-12 overflow-hidden bg-w-bg-card p-2 sm:p-3 gap-2 sm:gap-3">
        ...
        <div className="col-span-4 lg:col-span-4 h-full rounded-2xl overflow-hidden shadow-2xl bg-w-bg-alt border-2 border-w-accent-border flex flex-col relative p-4 items-center justify-between">
          
          <div className="w-full flex justify-between items-center text-xs font-black uppercase text-w-text-muted">
            <span className="text-rose-400">{distanceA}/10 bước</span>
            <span className="text-amber-600">Đua Cướp Cờ</span>
            <span className="text-blue-700">{distanceB}/10 bước</span>
          </div>

          {/* Running Track & Center Flag */}
          <div className="relative w-full max-w-sm aspect-square border-4 border-w-accent-border rounded-full flex items-center justify-center bg-w-bg-card shadow-2xl my-auto">
            ...
            <div className="w-20 h-20 bg-amber-500/20 border-2 border-amber-400 rounded-full flex flex-col items-center justify-center shadow-[0_0_30px_rgba(251,191,36,0.3)] z-20 animate-pulse">
              ...
              <span className="text-[9px] font-black text-amber-600">ĐÍCH</span>
            </div>
          ...
          <div className="w-full flex items-center gap-2">
            <div className="flex-1 bg-w-accent-light rounded-full h-3 p-0.5 overflow-hidden border border-w-accent-border">
              <div 
