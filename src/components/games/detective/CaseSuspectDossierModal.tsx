      ...
      >
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {contradictionRevealed && (
                          <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-md bg-red-600 text-white flex items-center gap-1 animate-pulse">
        ...
        <div className="bg-[#e8d8b9] p-3.5 border-t-2 border-[#b58b4c] flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="px-5 py-2 rounded-xl bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-500 hover:to-rose-600 text-white text-xs font-black uppercase tracking-wider transition cursor-pointer shadow-md flex items-center gap-1.5"
          >
