  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs animate-fade-in">
      <motion.div
        ...
        className="bg-[#FFFDF5] border-2 border-[#DED5B8] w-full max-w-lg rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col max-h-[85vh]"
      >
        {/* Header */}
        <div
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-white/80 font-bold">Danh Mục Tài Sản & Bất Động Sản</p>
            </div>
          </div>
        ...
        <div className="p-4 sm:p-5 space-y-4 overflow-y-auto custom-scrollbar flex-1">
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="p-3 bg-[#FAF7EE] rounded-2xl border border-[#E3DCBA]">
              <div className="text-[10px] font-bold text-[#74806B] uppercase">Tiền Mặt</div>
            ...
            <div className="p-3 bg-[#FAF7EE] rounded-2xl border border-[#E3DCBA]">
              <div className="text-[10px] font-bold text-[#74806B] uppercase">Giá Trị Đất</div>
              <div className="text-sm sm:text-base font-black text-[#4F683C]">
                ${totalPropertyValue.toLocaleString()}
              </div>
            </div>

            <div className="p-3 bg-[#FAF7EE] rounded-2xl border border-[#E3DCBA]">
              <div className="text-[10px] font-bold text-[#74806B] uppercase">Tổng Tài Sản</div>
              <div className="text-sm sm:text-base font-black text-[#35452E]">
          ...
          {team.freeRentTokens > 0 && (
            <div className="p-3 bg-purple-50 border border-purple-200 rounded-2xl flex items-center justify-between">
              ...
              <span className="text-xs font-black px-2.5 py-1 bg-purple-600 text-white rounded-xl">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs font-extrabold uppercase tracking-wider text-[#74806B]">
              <span>Khu Đất Sở Hữu ({ownedTiles.length})</span>
              <span>Tiền Thuê Hiện Tại</span>
            </div>

            {ownedTiles.length === 0 ? (
              <div className="text-center py-6 text-xs font-bold text-[#74806B] bg-[#FAF7EE] rounded-2xl border border-[#E3DCBA] italic">
              ...
              <div className="space-y-2">
                {ownedTiles.map(tile => {
                  ...
                  return (
                    <div
                      key={tile.id}
                      className="p-3 bg-white border border-[#DED5B8] rounded-2xl shadow-2xs flex items-center justify-between gap-2"
                    >
                      <div className="flex items-center gap-2.5">
                        <div
                          className="w-8 h-8 rounded-xl flex items-center justify-center text-base shrink-0 text-white"
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5 text-[10px] text-[#74806B] font-bold">
                            <span>{tile.groupName}</span>
                            <span>•</span>
                            <span className="text-[#4F683C] flex items-center gap-0.5">
        ...
        {/* Footer */}
        <div className="p-3.5 bg-[#FAF7EE] border-t border-[#DED5B8] flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 bg-[#4F683C] hover:bg-[#3D522B] text-white text-xs font-black rounded-xl shadow-xs transition cursor-pointer"
          >
            Đóng
          </button>
        </div>
