...
export const GAME_GUIDES_DATA: Record<string, GameGuideDetail> = {
  ...
  werewolf_village: {
    ...
    subtitle: 'Đấu trí điều tra 12 cư dân NPC do AI điều khiển',
    icon: '🐺',
    badge: 'Trinh thám & AI Engine',
    objective: 'Tìm ra toàn bộ Ma Sói ẩn mình trong 12 cư dân làng và giành số điểm cao nhất cho đội mình.',
    steps: [
      'Ban đêm (Night Engine): 12 NPC thông minh tự động thực hiện hành động bí mật (Sói cắn, Tiên tri soi, Bảo vệ tạo khiên, Phù thủy cứu/độc, Thợ săn).',
      'Bình minh (Dawn): Ngôi làng công bố danh tính người tử nạn đêm qua (nếu có) và các manh mối hiện trường kỳ bí.',
      'Hệ thống chọn ngẫu nhiên 1 đội: Đội trả lời ĐÚNG câu hỏi tri thức để mở khóa quyền chọn 1 NPC còn sống và dự đoán vai trò.',
      'Đoán ĐÚNG: Nhận ngay điểm thưởng (Điểm cơ bản × Hệ số ×2) và hé lộ nhân dạng thật của NPC đó.',
      'Đoán SAI: Không nhận điểm, nhân dạng NPC tiếp tục được bảo mật bí ẩn.',
    ],
    scoring: [
      'Mỗi câu hỏi đúng: Mở khóa quyền điều tra NPC',
      'Mỗi dự đoán trúng NPC: +200 điểm (hoặc Cơ bản × Hệ số) và hé lộ nhân dạng',
      'Đội có điểm số cao nhất sau số đêm quy định sẽ giành chiến thắng',
    ],
  },
  masoi: {
    id: 'masoi',
